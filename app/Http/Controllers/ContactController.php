...
class ContactController extends Controller
{
    ...
    {
        $data = $request->validate(['name' => 'required|string|max:100', 'contact' => 'required|string|max:190', 'subject' => 'required|in:bike,sell,other', 'message' => 'required|string|max:4000', 'consent' => 'accepted', 'website' => 'nullable|max:0']);
