...
<section class="stripe border-b-2 border-ink bg-forest px-5 py-20 text-white lg:px-8 lg:py-28">
    <div class="mx-auto max-w-7xl">
        <p class="inline-flex rounded-full border border-white/30 px-4 py-2 text-sm font-bold uppercase tracking-[.14em] text-sun">Fauske · Salten</p>
        <h1 class="mt-7 max-w-5xl font-display text-5xl uppercase leading-[.95] tracking-[-.045em] sm:text-6xl lg:text-8xl">Sykkelservice og brukte sykler i <span class="text-sun">Fauske</span></h1>
        <p class="mt-8 max-w-2xl text-xl leading-8 text-white/80">Trenger du sykkelservice eller er på utkikk etter en god brukt sykkel i Fauske? Han Sykkeltypen pusser opp og selger solide bruktsykler, og utfører vedlikehold som gjør sykkelen din klar for veien igjen.</p>
