...
<section class="grain bg-paper px-5 py-20 lg:px-8">
    <div class="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
        <div>
            <p class="eyebrow">Sykkelservice i Rognan</p>
            <h2>Vi henter sykkelen din i Rognan</h2>
            <p class="lead">Det skal være enkelt å gi sykkelen den omsorgen den trenger. Bor du i Rognan, kan vi avtale henting og levering av sykkelen din for service.</p>
            <p class="mt-4">Han Sykkeltypen dekker store deler av Salten, inkludert Rognan. Vi kan hente sykkelen din, gi den en grundig gjennomgang, og levere den tilbake i topp stand.</p>
        </div>
...
<section id="kontakt" class="grain bg-cream px-5 py-20 lg:px-8">
    <div class="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2">
        <div>
            ...
            <h2>Trenger du hjelp med sykkelen din i Rognan?</h2>
